...
def process_config(config_path: Path) -> None:
    ...
    with PdfPages(out_path) as pdf:
        ...
        fig_mrf = plot_mosaic_step(dataset, labels_mrf, title=plain_title, gt_labels=dataset.y, bounds=bounds)
        ...
        fig_mrf_s = plot_mosaic_step(dataset, labels_mrf_s, title=signed_title, gt_labels=dataset.y, bounds=bounds)
        ...
        fig_mrf_l = plot_mosaic_step(dataset, labels_mrf_l, title=log_title, gt_labels=dataset.y, bounds=bounds)
        ...
        fig_mrf_h1 = plot_mosaic_step(dataset, labels_mrf_h1, title=h1_title, gt_labels=dataset.y, bounds=bounds)
